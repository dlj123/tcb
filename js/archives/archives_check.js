	...
	require(['jquery', 'common', 'fastclick'], function($, common, fastclick) {
		...
		var archivesCheck = {
			...
			init: function() {
				...
				this.otherFlowCheck(archivesCheck.companyId02,archivesCheck.deptId02);
			...
			toIndex:function(){
				 ...
				 var path = window.location.search.slice(1);
				     ...
				     archivesCheck.companyId02 = path.companyId;

				     archivesCheck.deptId02 = path.deptId;
			...
			checkInit: function() {
				...
				var getStatus = function(value){
                     ...
                     else if(value=='31000002'){

                     	return "租房合同";
                     }
                     else if(value=='31000003'){

                       return "对外联系函";
                     }
                     else if(value=='31000004'){

                        return "其他";
                     }
                     else if(value=='31000005'){

                     	return "购房合同";
                     }
                     else if(value=='31000006'){

                     	return "外来联系函";
                     }
                     else if(value=='31000007'){

                     	return "生产合同";
                     }
                     else if(value=='31000008'){

                       return "油料合同";
                     }
                     else if(value=='31000009'){
                     	
                       return "管理合同";
                     }
                     else if(value=='31000010'){
                     	
                       return "股东合同";
                     }
                     else if(value=='31000011'){
                     	
                       return "红头合同";
                     }
                     else if(value=='91000001'){
                     	
                       return "日常行政文书1";
                     }
                     else if(value=='91000002'){
                     	
                       return "日常行政文书2";
                     }
                     else if(value=='11000011'){
                     	
                       return "管理文件制度1";
                     }
                     else if(value=='11000012'){
				...
				$.ajax({
					...
					success: function(res) {
						...
						$('.fileType').html(getType(res.wxOaDoc.fileType)); //文案类型
						$('.status').html(getStatus(res.wxOaDoc.status)); //合同类型
