	...
	require(['jquery','common','fastclick'], function ($, common,fastclick) {
      ...
      deptId02:'',
			...
			init:function(){
                 ...
                 this.otherFlowCheck(productionRewardCheck.companyId02,productionRewardCheck.deptId02);
                  ...
                  toIndex:function(){
                   ...
                   var path = window.location.search.slice(1);
                       ...
                       productionRewardCheck.companyId02 = path.companyId;

                       productionRewardCheck.deptId02 = path.deptId;
                    ...
                    $.ajax({
                        ...
                        for(var i = 0;i<fileLists.length;i++){
                            ...
                            $('.position').html(res.wxOaDoc.nPositionName);
                             ...
                             $('.rewardCause').html(res.wxOaDoc.rewardCause);
