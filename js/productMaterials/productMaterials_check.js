	...
	require(['jquery', 'common', 'fastclick'], function($, common, fastclick) {
		...
		var productMaterialsCheck = {
			...
			init: function() {
                ...
                this.otherFlowCheck(productMaterialsCheck.companyId02,productMaterialsCheck.deptId02);
			},
			toIndex:function(){
				...
				var path = window.location.search.slice(1);
				   ...
				   productMaterialsCheck.companyId02 = path.companyId;

				   productMaterialsCheck.deptId02 = path.deptId;
			...
			checkInit: function() {
				...
				$.ajax({
					...
					success: function(res) {
						...
						$('.status').html(getValue(res.wxOaDoc.status)); // 使用类别
