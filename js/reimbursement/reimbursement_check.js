require(['../config'],function(config) {
	...
	require(['jquery','common','fastclick'], function ($, common,fastclick) {
        ...
        var id,taskId,instanceId,companyId,empower,staffId,isAccredit,deptId;

		var reimbursementCheck = {
      ...
      deptId02:'',
			...
			init:function(){
                 ...
                 this.otherFlowCheck(reimbursementCheck.companyId02,reimbursementCheck.deptId02);
              ...
              toIndex:function(){
                  ...
                  var path = window.location.search.slice(1);
                      ...
                      reimbursementCheck.companyId02 = path.companyId;

                      reimbursementCheck.deptId02 = path.deptId;
                    ...
                    $.ajax({
                    	...
                    	success:function(res){
                            ...
                            if(!res.activitiAccredit && empower=='100011002'){
                             ...
                             $('.position').html(res.wxOaDoc.nPositionName);

                             $('.people').html(res.wxOaDoc.nUserName);

                             var oaDocBxList = res.wxOaDoc.oaDocBxList;
                             
                             for (var i = 0; i < oaDocBxList.length; i++) {

                               var s = "";

                               s += "<li><div class='label'>预算内费用</div><div class='value inLoan'>"+oaDocBxList[i].IN_LOAN+"</div></li>";
                               s += "<li><div class='label'>预算外费用</div><div class='value inLoan'>"+oaDocBxList[i].OUT_LOAN+"</div></li>";
                               s += "<li><div class='label'>金额</div><div class='value inLoan'>"+oaDocBxList[i].MONEY+"</div></li>";
                               s += "<li><div class='label'>打入姓名</div><div class='value inLoan'>"+oaDocBxList[i].TURN_TO_NAME+"</div></li>";
                               s += "<li><div class='label'>打入卡号</div><div class='value inLoan'>"+oaDocBxList[i].TURN_TO_NUMBER+"</div></li>";
                               s += "<li><div class='label'>摘要</div><div class='value inLoan'>"+oaDocBxList[i].ROUNDUP+"</div></li>";

                               $(".applyTable_list").append(s);
                             }
	                         	...
	                         	success:function(res){
	                              ...
	                              $('#pass_box').hide();	                             
	                                ...
	                                common.maskConfirm02("操作成功！！",function(){
                                       ...
                                       window.location.href='../launchCheck/check.html?tab=2&companyId='+speedCheck.companyId02+'&deptId='+speedCheck.deptId02;
