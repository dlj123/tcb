	...
	require(['jquery','common','fastclick'], function ($, common,fastclick) {
      ...
      deptId02:'',
			...
			init:function(){
                 ...
                 this.otherFlowCheck(moneyPlanCheck.companyId02,moneyPlanCheck.deptId02);
                    ...
                    $.ajax({
                        ...
                        for(var i = 0;i<fileLists.length;i++){
                            ...
                            if(!res.activitiAccredit && empower=='100011002'){
                             ...
                             $('.payee').html(res.wxOaDoc.payee);

                             $('.payable').html(res.wxOaDoc.payable);

                             $('.actualMoney').html(res.wxOaDoc.actualMoney);

                             $('.paymentDetail').html(res.wxOaDoc.paymentDetail);
