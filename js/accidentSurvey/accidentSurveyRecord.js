                ...
                $.ajax({
                             ...
                             if(res.status == 200){
                               ...
                               var picList = res.data.oaDocPicList,picHtml="",fileList= res.data.oaDocFileList,fileHtml="";
                                     ...
                                     $('.accidentName').html(res.data.wxOaDoc.accidentName);

                                     $('.place').html(res.data.wxOaDoc.place);

                                     $('.witness').html(res.data.wxOaDoc.witness);

                                     $('.accidentType').html(res.data.wxOaDoc.accidentType);
