	...
	require(['jquery','common','fastclick'], function ($, common,fastclick) {
      ...
      deptId02:'',
			...
			init:function(){
                 ...
                 this.otherFlowCheck(accidentSurvyCheck.companyId02,accidentSurvyCheck.deptId02);
              ...
              toIndex:function(){
                  ...
                  var path = window.location.search.slice(1);
                    ...
                    path = common.parseUrl(path);
                     ...
                     accidentSurvyCheck.companyId02 = path.companyId;

                     accidentSurvyCheck.deptId02 = path.deptId;
                    ...
                    $.ajax({
                        ...
                        for(var i = 0;i<fileLists.length;i++){
                            ...
                            if(!res.activitiAccredit && empower=='100011002'){
                             ...
                             $('.accidentName').html(res.wxOaDoc.accidentName);

                             $('.place').html(res.wxOaDoc.place);

                             $('.witness').html(res.wxOaDoc.witness);

                             $('.accidentType').html(res.wxOaDoc.accidentType);
