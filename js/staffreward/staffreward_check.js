			...
			checkInit: function() {
				...
				$.ajax({
					...
					success: function(res) {
						...
						$('.memo').html(res.wxOaDoc.memo); // 奖励类型
						$('.money').html(res.wxOaDoc.money); // 奖励金额
						$('.rewardCause').html(res.wxOaDoc.rewardCause); // 奖励事由
