		...
		var staffrewardSubmit = {
			...
			param: function() {
				...
				if($('#gohome_fail')) {
					...
					$('#gohome_fail').attr('href', '../home/index.html?companyId=' + path.companyId);

				}

				if($('#gohome_success')) {

					$('#gohome_success').attr('href', '../home/index.html?companyId=' + path.companyId);

				}
			}
		}
		staffrewardSubmit.init();
	})
})