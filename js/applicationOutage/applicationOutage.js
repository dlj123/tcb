 require(['../config'],function(config) {
	...
	require(['jquery','common','fastclick','webuploader'], function ($, common,fastclick,webuploader) {
          ...
          var applicationOutage = {
              ...
              this.applicationOutageSubmit();

              this.applicationOutageRecord();
            ...
            carNumInit:function(){
              ...
              $('.carNum_wrap').on('click',function(){
                   ...
                   deptId = $('.carNum_wrap').attr('data-deptid');
            ...
            startTime:function(){
             ...
             productionTime:function(){
              ...
              $('.productionTime_wrap').on('click',function(){

                 var productionTimepicker;

                 if(!productionTimepicker){

                   productionTimepicker = new mui.DtPicker({
                  ...
                  productionTimepicker.show(function(items) {

                      console.log(items);

                      $('#productionTime').html(items.text);
           ...
           delUppic:function(){
            ...
            applicationOutageSubmit:function(){
              ...
              $('.submit_wrap').on('click','.submit_btn',function(){
                  ...
                  var wxOaDoc = {};
                      ...
                      wxOaDoc.memo = selectValue02($('.leaveMark').val());
                      ...
                      var productionDate = selectValue($('#productionTime').html());
                      ...
                      if(wxOaDoc.nCompanyName.trim() =='请选择' || startDate.trim() =='请选择'){
                        ...
                        $.ajax({
                            ...
                            data:{
                              ...
                              productionDate:selectValue($('#productionTime').html())
                            ...
                            success:function(res){
                               ...
                               if (res.status=="200") {
                                 ...
                                 window.location.href="applicationOutage_submit_success.html?companyId="+companyId+"&oaDocId="+oaDocId+"&formType="+wxOaDoc.formType+'&deptId='+deptId
            ...
            //停运申请初始化
            applicationOutageRecord:function(){
                ...
                $.ajax({
                    ...
                    success:function(res){
                      ...
                      var applicationOutageList = res.data.wxOaDocList;

                        for (var i = applicationOutageList.length-1; i >= 0; i--) {
                
                                                listHtml +='<li class="item"><a href="applicationOutage_record.html?oaDocId='+applicationOutageList[i].id+'&companyId='+companyId+'&deptId='+deptId+'">';

                                                listHtml +=   '<div class="name">'+applicationOutageList[i].nCompanyName+'</div>';

                                                listHtml +=         '<div class="leave_infos">';

                                                listHtml +=           '<div class="time_reason">';

                                                listHtml +=             '<p>部门：'+applicationOutageList[i].nDeptName+'</p>';

                                                 listHtml +=            '<p>人员：'+applicationOutageList[i].nUserName+'</p>';

                                                listHtml +=             '<p>起始日期：'+applicationOutageList[i].startDate+'</p>';

                                                listHtml +=         ' </div>';

                                                if(applicationOutageList[i].applyType=='60011003'){

                                                  listHtml +=          '<span class="icon check"></span>';

                                                }
                                                else if(applicationOutageList[i].applyType=='60011002'){

                                                  listHtml +=          '<span class="icon failIcon"></span>';

                                                }
                                                else if(applicationOutageList[i].applyType=='60011001'){
                             ...
                             $('#applicationOutage_record').html(listHtml);
