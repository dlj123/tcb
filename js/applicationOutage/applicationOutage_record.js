         ...
         $.ajax({
                     ...
                     if(res.status == 200){
                       ...
                       var picList = res.data.oaDocPicList,picHtml="",fileList= res.data.oaDocFileList,fileHtml="";
                             ...
                             $('.start_time').html(res.data.wxOaDoc.startDate);

                            $('.production_time').html(res.data.wxOaDoc.productionDate);

                             $('.applicationMemo').html(res.data.wxOaDoc.memo);
