	...
	require(['jquery','common','fastclick'], function ($, common,fastclick) {
      ...
      deptId02:'',
			...
			init:function(){
                 ...
                 this.otherFlowCheck(productionDeductionCheck.companyId02,productionDeductionCheck.deptId02);
              ...
              toIndex:function(){
                   ...
                   var path = window.location.search.slice(1);
                       ...
                       productionDeductionCheck.companyId02 = path.companyId;

                       productionDeductionCheck.deptId02 = path.deptId;
                    ...
                    $.ajax({
                        ...
                        for(var i = 0;i<fileLists.length;i++){
                            ...
                            $('.position').html(res.wxOaDoc.nPositionName);
                             ...
                             $('.deductionCause').html(res.wxOaDoc.deductionCause);
