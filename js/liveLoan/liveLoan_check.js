	...
	require(['jquery','common','fastclick'], function ($, common,fastclick) {
      ...
      deptId02:"",
			...
			init:function(){
                 ...
                 this.otherFlowCheck(liveLoanCheck.companyId02,liveLoanCheck.deptId02);
              ...
              toIndex:function(){
                ...
                var path = window.location.search.slice(1);
                    ...
                    liveLoanCheck.companyId02 = path.companyId;

                    liveLoanCheck.deptId02 = path.deptId;
                    ...
                    $.ajax({
                        ...
                        for(var i = 0;i<fileLists.length;i++){
                            ...
                            if(!res.activitiAccredit && empower=='100011002'){
                             ...
                             $('.entryDate').html(res.wxOaDoc.entryDate);
