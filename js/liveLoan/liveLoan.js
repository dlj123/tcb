 require(['../config'],function(config) {
  ...
  require(['jquery','common','fastclick'], function ($, common,fastclick) {
          ...
          var companyName="",deptName="",staffName="",entryDate="";
            ...
            dataInit:function(){
                 ...
                 $.ajax({
                    ...
                    success:function(res){
                      ...
                      entryDate = res.tmUser.entryDate;
           ...
           delUppic:function(){
            ...
            liveLoanSubmit:function(){
              ...
              $('.submit_wrap').on('click','.submit_btn',function(){
                      ...
                      wxOaDoc.formType ='shfjk';

                      wxOaDoc.entryDate = entryDate;
                        ...
                        $.ajax({
                            ...
                            success:function(res){
                               ...
                               if (res.status=="200") {
                                 ...
                                 window.location.href="liveLoan_submit_success.html?companyId="+companyId+"&oaDocId="+oaDocId+"&formType="+wxOaDoc.formType+"&deptId="+deptId
            ...
            liveLoanRecord:function(){
                ...
                $.ajax({
                    ...
                    success:function(res){
                      ...
                      var liveLoanList = res.data.wxOaDocList;

                        for (var i = liveLoanList.length-1; i >= 0; i--) {
                
                                                listHtml +='<li class="item"><a href="liveLoan_record.html?oaDocId='+liveLoanList[i].id+'&companyId='+companyId+'&deptId='+deptId+'">';

                                                listHtml +=   '<div class="name">'+liveLoanList[i].companyName+'</div>';

                                                listHtml +=         '<div class="leave_infos">';

                                                listHtml +=           '<div class="time_reason">';

                                                listHtml +=             '<p>部门：'+liveLoanList[i].deptName+'</p>';

                                                listHtml +=            '<p>借款人：'+liveLoanList[i].userName+'</p>';

                                                listHtml +=         ' </div>';

                                                if(liveLoanList[i].applyType=='60011003'){

                                                  listHtml +=          '<span class="icon check"></span>';

                                                }
                                                else if(liveLoanList[i].applyType=='60011002'){

                                                  listHtml +=          '<span class="icon failIcon"></span>';

                                                }
                                                else if(liveLoanList[i].applyType=='60011001'){
