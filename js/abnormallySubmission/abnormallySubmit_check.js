	...
	require(['jquery','common','fastclick'], function ($, common,fastclick) {
      ...
      deptId02:'',
			...
			init:function(){
                 ...
                 this.otherFlowCheck(abnormallySubmitCheck.companyId02,abnormallySubmitCheck.deptId02);
        ...
        toIndex:function(){
              ...
              var path = window.location.search.slice(1);
                  ...
                  abnormallySubmitCheck.companyId02 = path.companyId;

                  abnormallySubmitCheck.deptId02 = path.deptId;
                    ...
                    $.ajax({
                        ...
                        for(var i = 0;i<fileLists.length;i++){
                            ...
                            if(!res.activitiAccredit && empower=='100011002'){
                             ...
                             $('.stop_date').html(res.wxOaDoc.stopDate);

                             $('.directDamage').html(res.wxOaDoc.directDamage);
