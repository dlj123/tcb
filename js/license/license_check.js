	...
	require(['jquery','common','fastclick'], function ($, common,fastclick) {
      ...
      deptId02:'',
			...
			init:function(){
                 ...
                 this.otherFlowCheck(speedCheck.companyId02,speedCheck.deptId02);
              ...
              toIndex:function(){
                  ...
                  speedCheck.companyId02 = path.companyId;

                  speedCheck.deptId02 = path.deptId;

                  $('.asidemenu').on('click',function(){

                      window.location.href="../home/index.html?companyId="+path.companyId+"&deptId="+path.deptId
                  })
                    ...
                    $.ajax({
                        ...
                        for(var i = 0;i<fileLists.length;i++){
                            ...
                            if(!res.activitiAccredit && empower=='100011002'){
                                 ...
                                 //90011001  授权审核办理  90011002  授权审核未办理 
    	                            ...
    	                            if(res.activitiAccredit.status=='90011001'){
    	                             ...
    	                             else if(res.activitiAccredit.status=='90011002'){
                             ...
                             if(res.wxOaDoc.certificateNumber==undefined){

                               $('.certifyNumber').html('0次');

                             }
                             
                             else{

                               $('.certifyNumber').html(res.wxOaDoc.certificateNumber+'次');

                             }

                             if(res.wxOaDoc.licenseType=='11000001'){

                                $('.license_type').html("人为破坏");

                             }
                            
                             else if(res.wxOaDoc.licenseType=='11000002'){

                                $('.license_type').html("牌证丢失");

                             }
                             
                             else if(res.wxOaDoc.licenseType=='11000003'){

                                $('.license_type').html("自然损耗");
